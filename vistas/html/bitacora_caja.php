...
$sql1 = mysqli_query($conexion, "select * from users");
    ...
    ?>
											...
											<div class="col-md-3">
												...
												<button type="button" class="btn btn-success waves-effect waves-light" data-toggle="modal" data-target="#nuevaCaja"><i class="fa fa-plus"></i> Agregar</button>
												</div>
...
<script type="text/javascript" src="../../js/bitacora_caja.js"></script>
<script>
	$(function () {
