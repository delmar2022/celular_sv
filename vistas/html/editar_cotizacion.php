												...
												<div class="editar_factura" class='col-md-12' style="margin-top:10px"></div><!-- Carga los datos ajax -->
													<form role="form" id="datos_factura">
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group">
																	<label for="cotizacion">NO.COTIZACION</label>
														...
														<div class="row">
															...
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<div class="total"></div><!-- Carga los datos ajax -->
																</div>
															</div>
														</div>
														...
														<div class="row">
															...
															<div class="col-md-6">
																<button type="button" class="btn btn-success waves-effect waves-light" id="btn_guardar"><span class="ti-shopping-cart-full"></span> FACTURAR</button>
															</div>
														</div>
													</form>
