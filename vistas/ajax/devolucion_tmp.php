...
if (isset($_GET['id'])) //codigo elimina un elemento del array
{
    ...
    $id_fact      = get_row('detalle_fact_ventas', 'id_factura', 'id_detalle', $id_detalle);
    $num_fact     = get_row('detalle_fact_ventas', 'numero_factura', 'id_detalle', $id_detalle);
    $quantity     = get_row('detalle_fact_ventas', 'cantidad', 'id_detalle', $id_detalle);
    $precio_venta = get_row('detalle_fact_ventas', 'precio_venta', 'id_detalle', $id_detalle);
    $importe      = get_row('detalle_fact_ventas', 'importe_venta', 'id_detalle', $id_detalle);
    ...
    $insert_tmp   = mysqli_query($conexion, "INSERT INTO detalle_devolucion (id_factura,numero_factura, id_producto,cantidad,precio_venta,importe_venta) VALUES ('$id_fact','$num_fact','$id_prod','$quantity','$precio_venta','$importe')");
}
