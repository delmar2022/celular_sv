...
while ($row = mysqli_fetch_array($query)) {
            ...
            if ($tipo_proveedor == 1) {
                $tip = "<span class='badge badge-warning'>Empresa</span>";
            } else {
                $tip = "<span class='badge badge-info'>Corriente</span>";
            }
            ...
            ?>
                    ...
                    <input type="hidden" value="<?php echo $cel_proveedor; ?>" id="cel_proveedor<?php echo $id_proveedor; ?>">
                    <input type="hidden" value="<?php echo $estado_proveedor; ?>" id="estado_proveedor<?php echo $id_proveedor; ?>">
                    <input type="hidden" value="<?php echo $tipo_proveedor; ?>" id="tipo_proveedor<?php echo $id_proveedor; ?>">
