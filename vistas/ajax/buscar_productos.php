        ...
        <div class="table-responsive">
          <table class="table table-sm table-striped">
            <tr  class="info">
                ...
                <th class='text-left'>VENTA1</th>
                <th class='text-left'>VENTA2</th>
                <th class='text-left'>VENTA3</th>
                <th>Estado</th>
                <th>Agregado</th>
...
while ($row = mysqli_fetch_array($query)) {
            ...
            ?>
                ...
                <input type="hidden" value="<?php echo number_format($costo2_producto, 2, '.', ''); ?>" id="costo2_producto<?php echo $id_producto; ?>">
