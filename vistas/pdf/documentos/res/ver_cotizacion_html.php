...
$t = $subtotal * 0.01;
$total_factura = $subtotal + $total_impuesto + $t;
?>
...
<tr>
        ...
        <tr>
            <td colspan="3" style="widtd: 85%; text-align: right;">(-) RETENIDO</td>
            <td style="widtd: 15%; text-align: right;"> <?php echo number_format($t, 2); ?></td>
        </tr>
        <tr>
