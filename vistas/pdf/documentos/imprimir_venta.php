...
$sql_cliente    = mysqli_query($conexion, "select * from facturas_ventas, clientes where facturas_ventas.id_cliente=clientes.id_cliente and id_factura='" . $factura_id . "'");
    ...
    <table width="175px" style="font-size:12px; font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif" border="0" >
        ...
        <tr>
            <td colspan="4">
                ...
                <div align="left">Cliente: <?php echo $nombre_cliente; ?><br></div>
            </td>
        </tr>
        <tr>
        </tr>
