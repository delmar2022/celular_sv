...
function load(page) {
  ...
  $.ajax({
    url:
      "../ajax/productos_modal_compras2.php?action=ajax&page=" +
      page +
      "&q=" +
      q +
      "&categoria=" +
...
function agregar(id) {
  ...
  if (isNaN(cantidad)) {
    $.Notification.notify(
      ...
      "bottom center",
      "ERROR!",
      "LA CANTIDAD DIGITADA NO ES UN FORMATO VALIDO"
    );
  ...
  if (isNaN(costo_producto)) {
    $.Notification.notify(
      ...
      "bottom center",
      "ERROR!",
      "EL COSTO DIGITADO NO ES UN FORMATO VALIDO"
    );
...
function imprimir_factura(id_factura) {
  VentanaCentrada(
    "../pdf/documentos/ver_comprax.php?id_factura=" + id_factura,
    "Factura",
    "",
    "724",
    "468",
